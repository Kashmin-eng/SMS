            ...
            <!-- Navbar Right Menu -->
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                 ...
                 <li class="">
                    <!-- Menu Toggle Button -->
                   <a href="home.php" class="" style="font-size:14px"><i class="glyphicon glyphicon-list-alt"></i> Class Schedule</a>
                  </li>
                  <!-- Tasks Menu -->
                  <!-- Tasks Menu -->
                 <li class="">
              ...
              <li><!-- start notification -->
				  ...
				  <li class="">
                    <!-- Menu Toggle Button -->
                    <a href="../admin/includes/dashboard.php" class="dropdown-toggle">
