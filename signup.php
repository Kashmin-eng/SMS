...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(fname,lname,roll,email,password,contactno) values('$fname','$lname','$roll','$email','$password','$contact')");
...
<input class="form-control" id="roll" name="roll" type="text" placeholder="" required />
<label for="inputEmail">College Roll No</label>
</div>
